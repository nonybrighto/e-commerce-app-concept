import 'package:ecommerceui/product_page.dart';
import 'package:ecommerceui/widgets/clip_shadow_path.dart';
...
class TrendingItem extends StatelessWidget {
                                      ...
                                      Row(children: <Widget>[
                                        ...
                                        Card(
                                          ...
                                          child: Padding(
                                            ...
                                            child: Text('${product.remainingQuantity} left', style: TextStyle(color: Colors.white, fontSize: 12.0),),
                                          ),  
                                        ),
                                        Spacer(),
                                        Icon(Icons.favorite_border, color: Color(0XFFd0d0d0),)
                                      ],),
  ...
  _productImage(){
    ...
    return Stack(
      children: <Widget>[
        ...
        Center(
          child: Container(width: 100, height: 80, decoration: BoxDecoration(
  ...
  _productDetails(){
    ...
    return Column(
      ...
      children: <Widget>[
        Text(product.company, style: TextStyle(fontSize: 12, color: Color(0XFFb1bdef)),),
        Text(product.name, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 11),),
        StarRating(rating: product.rating, size: 10),
        Row(
          children: <Widget>[
          Text(product.price, style: TextStyle(fontSize: 15,  fontWeight: FontWeight.bold,color: Color(0XFF85c2ff))),
          Text('#00.000', style: TextStyle(color: Colors.grey, fontSize: 10, decoration: TextDecoration.lineThrough),)
        ],)
